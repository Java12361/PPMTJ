...
int doIsland5(char player[])
{
    ...
    if (doChoiceQues(Q1, CQ1, 4)==4)
    {
        ...
        print_mid("____________________________________________________________________________________\n");
        sleep(1);
        print_mid("\' This pirate of the over sea,	    No black-hulled brig he sails,");
        sleep(1);
        print_mid("No black flag at the mizzen-peak	    Flaunts death-heads to the gales.");
        sleep(1);
        print_mid("Yet fiercer than the wild Corsair	This pirate of the upper air.");
        sleep(1);
        print_mid("Watch how he listless drifts along,	His wings with winds at sport—");
        sleep(1);
        print_mid("But look! a sail has hove in sight,	A dove has crossed to port.");
        sleep(1);
        print_mid("See how he crowds on ev'ry sail      And screams his war-cry to the gale. \'\n");
        sleep(1);
        ...
        if (doChoiceQues(Q2, CQ2, 4)==3)
        {
            ...
            print_mid("____________________________________________________________________________________\n");
            sleep(1);
            print_mid("\'This noble monarch of the Afric waste		Meets with no rival to contest his reign,");
            sleep(1);
            print_mid("With his surpassing strength and agile stride		He can o'er come each creature of the plain.");
            sleep(1);
            print_mid("He dashes to the earth the tall giraffe			Who towers above the summits of the woods;");
            sleep(1);
            print_mid("He tracks the herds of shaggy buffaloes,			And slays the bull in solitudes;");
            sleep(1);
            print_mid("He preys on nimble flocks of antelopes,			The pallah, oryx, quagga and wild-beest.");
            sleep(1);
            print_mid("O'ertakes the blesbok in its swiftest flight,		On zebra and the eland makes his feast. \'");
            sleep(1);
            ...
            if (doChoiceQues(Q3, CQ3, 4)==3)
            {
                ...
                print_mid("____________________________________________________________________________________\n");
                sleep(1);
                print_mid("\'A narrow fell** in the grass		Occasionally rides");
                sleep(1);
                print_mid("You may have met him, — d*d you not,	His notice sud**n is.");
                sleep(1);
                print_mid("The grass div*des as with a comb,		A sp**ted shaft is seen;");
                sleep(1);
                print_mid("And ***n it closes at your feet		And opens further *n. \'");
                sleep(1);
